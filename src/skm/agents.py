...
def resolve_agent_specs(
    ...
    if selected_names is None:
        names = config_agents.default if config_agents and config_agents.default is not None else list(agent_specs)
        validate_agent_names(names, agent_specs, "agents.default")
    else:
